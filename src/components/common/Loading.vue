<template>
  <div>
      ...
      <svg class="nyan" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <g class="pig">
          ...
          <g class="snout">
            ...
            <rect class="snout-holes" width="1" height="3" transform="translate(17 11) rotate(90)"></rect>
    ...
    <span class="loader-text">KEEP WORKING...</span>
  </div>
</template>
<style scoped>
* {
...
body {
  ...
  color: #ffffff;
  background: #0a0916 radial-gradient(circle at center, #151333 0%, #0a0916 80%) no-repeat;
}
