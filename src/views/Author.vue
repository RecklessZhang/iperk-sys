<template>
  <div class="mt-10" style="width: 99vw; height: 70vh; display: flex; justify-content: center; align-items: center;">
    <div class="card">
      <div class="img">
        <img src="../../public/author.jpg" style="display: inline-block; width: 100%; height: 100%; border-radius: 10px;">
      </div>
      ...
      <div class="share">
        <a @click="() => { this.$router.push('/github') }"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
      ...
      <button @click="() => { this.$router.push('/resume') }">Resume</button>
    </div>
  </div>
</template>
<style>
